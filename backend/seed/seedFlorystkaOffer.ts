...
async function generateCompanyName(categoryName: string): Promise<string> {
    const keywords = ["Kwiaty", "Bukiet", "Dekoracja", "Płatki", "Natura", "Uroda", "Harmonia", "Elegancja", "Szyk", "Piękno", "Romantyzm", "Kreatywność", "Pasja", "Styl", "Delikatność", "Wiosna", "Róże", "Tulipany", "Frezje", "Piwonie", "Kompozycja", "Aranżacja", "Ozdoba", "Ślub", "Wesele", "Plener", "Kolor", "Zapach", "Inspiracja", "Tradycja", "Nowoczesność"];
    const baseNames = ["Pracownia", "Florystka", "Studio", "Kwiaciarnia"];
    const additionalWords = ["Ślubna", "Weselna", "Kreatywna", "Naturalna"];
    ...
    2. Poprawna gramatyka i odmiana (np. "Pracownia Ślubna" a nie "Pracownia Ślub", "Florystka Kwiatów" a nie "Florystka Kwiat")
    3. Zakazane elementy:
       - Cyfry w jakiejkolwiek formie (np. "Studio 2", "Kwiaciarnia Trzy")
       - Znaki specjalne poza myślnikami
       - Skróty i numery porządkowe (II, III, 1st)
    4. Preferowane są polskie nazwy, używające słów takich jak "${baseNames.join('", "')}" jako baza, z dodatkami odnoszącymi się do profesjonalnych usług florystycznych na wesela. Nazwy powinny sugerować różnorodność usług (np. bukiety ślubne, dekoracje kościoła, aranżacje stołów, kwiaty do butonierki) i kreatywność. Słowa kluczowe do wykorzystania: "${keywords.join('", "')}".
    ...
    - "Kwiaciarnia Kwiatów II"
    - "Studio 3"
    - "Pracownia 2024"
    - "Florystka Pierwsza"
    
    PRZYKŁADY PREFEROWANYCH NAZW:
    - "Pracownia Kwiatów Ślubnych"
    - "Florystka Kreatywnych Bukietów"
    - "Studio Weselnej Harmonii"
    - "Kwiaciarnia Różanych Inspiracji"
...
async function generateInitialText(categoryName: string, filterNames: string[], companyName: string): Promise<{ bandName: string; shortDescription: string; longDescription: string }> {
    ...
    2. Treść:
       ...
       - Opisz: historię firmy, specjalizację (bukiety ślubne, dekoracje kościoła i sali, aranżacje stołów, butonierki), ofertę (kwiaty sezonowe, personalizowane kompozycje, dekoracje plenerowe), podejście do klienta (konsultacje, dobór kolorów), użyte materiały (świeże kwiaty, dodatki florystyczne)
       - Podkreśl unikalne wartości (kreatywność, dbałość o detal, naturalność, elegancja)
  ...
  async function expandTextPart1(existingText: string, bandName: string, filterNames: string[]): Promise<string> {
    ...
    4. Tematyka rozszerzenia:
       - Specyficzne usługi (np. dekoracje łuków ślubnych, girlandy kwiatowe, bukiety dla druhen, aranżacje tortu)
       - Materiały i techniki (np. świeże róże, suszone dodatki, ręczne wiązanie bukietów)
       - Przykładowe realizacje (np. rustykalne wesele, elegancka ceremonia w kościele)
  ...
  async function expandTextPart2(existingText: string, bandName: string, filterNames: string[]): Promise<string> {
    ...
    3. Wpleć motyw: "${keywords.join('", "')}"
    4. Tematyka rozszerzenia:
       - Doświadczenia z Parami Młodymi (np. konsultacje przedślubne, dopasowanie do motywu wesela)
       - Unikalne usługi (np. warsztaty florystyczne, dekoracje z recyklingu, szybka dostawa bukietów)
       - Wizja i wartości (np. tworzenie romantycznej atmosfery, podkreślanie piękna natury)
       - Call-to-action (subtelnym tonem, np. zachęta do kontaktu w sprawie dekoracji)
...
async function generateOfferData(category: any): Promise<OfferData> {
  ...
  const allImages = [
    '/uploads/images/flor1.png',
    '/uploads/images/flor2.png',
    '/uploads/images/flor3.png',
    '/uploads/images/flor4.png',
    '/uploads/images/flor5.png',
    '/uploads/images/flor6.png',
    '/uploads/images/flor7.png',
    '/uploads/images/flor8.png',
    '/uploads/images/flor9.png',
    '/uploads/images/flor10.png',
    '/uploads/images/flor11.png',
    '/uploads/images/flor12.png',
    '/uploads/images/flor13.png',
    '/uploads/images/flor14.png',
    '/uploads/images/flor15.png',
    '/uploads/images/flor16.png',
    '/uploads/images/flor17.png',
    '/uploads/images/flor18.png',
    '/uploads/images/7.png',
    '/uploads/images/6.png',
    '/uploads/images/10.png',
    '/uploads/images/14.png',
    '/uploads/images/18.png',
    '/uploads/images/1731508551460-jeny_51642_Bohemian_wedding_photo_shoot_in_the_forest._a_beauti_738a3173-f525-49d7-b10c-3fa895ed98cd.png',
    '/uploads/images/1731506949013-umitamar_a_luxury_wedding_in_dubai__near_to_borj_khalifa__with__8684ad62-ed4a-42ee-bcd2-8cfc895c9873.png',
    '/uploads/images/1731506948990-thomasinaction_a_wedding_arbour_on_a_beautiful_landscape._The_a_0c778f32-57a4-4fb7-abe6-c19bd8524014.png',
  ]
  ...
  media.splice(videoIndex, 0, {
    mediaType: 'video',
    mediaUrl: 'TRVdbODHAEc?si=8jTSfiVqsHlNeLy8'
  });
...
async function generateReviewData(listingId: number): Promise<ReviewData[]> {
    ...
    const prompt = `
    Wygeneruj od 3 do 5 realistycznych opinii w języku polskim dla florystki lub firmy florystycznej oferującej usługi weselne. 
    ...
    - "ratingQuality": ocena jakości (3-5, np. jakość kwiatów, trwałość bukietów)
    - "ratingCommunication": ocena komunikacji (3-5)
    - "ratingCreativity": ocena kreatywności (3-5, np. aranżacje, dobór kwiatów)
        ...
        const defaultReviews = [
            {
              ...
              reviewText: "Bukiet ślubny był przepiękny, a kwiaty zachowały świeżość przez całe wesele. Dekoracje kościoła dodały romantyzmu dzięki kreatywności florystki!"
            },
            {
              ratingQuality: faker.number.int({ min: 4, max: 5 }),
              ...
              ratingAesthetics: faker.number.int({ min: 4, max: 5 }),
              reviewText: "Aranżacja stołów zachwyciła elegancją i stylem, a piwonie w bukiecie były cudowne. Komunikacja mogła być szybsza, ale efekt końcowy wart czekania."
            },
            {
              ...
              reviewText: "Dekoracje były piękne, choć niektóre kwiaty mogłyby być trwalsze. Kompozycja na plenerze stworzyła magiczną atmosferę!"
            }
          ];
...
const category = categories.find((cat: any) => cat.service_category_id === 14);
